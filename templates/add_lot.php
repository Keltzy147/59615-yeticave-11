...
<form class="form form--add-lot container <?= $form_classname; ?>" action="add.php" method="post"
    ...
    <div class="form__container-two">
        ...
        <div class="form__item <?= $classname; ?>">
            ...
            <input id="lot-name" type="text" name="lot-name" value="<?= getPostVal('lot-name'); ?>"
            ...
            <select id="category" name="category">
                <?php foreach ($categories as $category): ?>
                    <option value="<?= $category['id'] ?>"
                            <?php if ($category['id'] == getPostVal('category')): ?>selected<?php endif; ?>><?= $category['name'];
                        ?></option>
                <?php endforeach; ?>
            </select>
            <?php if ($classname): ?>
