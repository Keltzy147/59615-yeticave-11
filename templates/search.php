<div class="container">
    ...
    <?php if (!empty($lots)): ?>
        <ul class="pagination-list">
            <li class="pagination-item pagination-item-prev"><a href ="?search=<?=$search;?>&page=<?=$cur_page-1;?>">Назад</a></li>
            <?php foreach ($pages as $page):?>
                <li class="pagination-item <?php if($page == $cur_page): ?>pagination-item-active<?php endif;?>">
                    <a href="?search=<?=$search;?>&page=<?=$page;?>"><?=$page;?></a>
                </li>
            <?php endforeach; ?>
            <li class="pagination-item pagination-item-next"><a href="?search=<?=$search;?>&page=<?=$cur_page+1;?>">Вперед</a></li>
        </ul>
    <?php endif ?>
</div>